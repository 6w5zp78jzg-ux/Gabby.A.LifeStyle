    ...
    <SmoothScroll>
      <main className="min-h-screen w-full">
        ...
        <nav className="fixed top-0 w-full p-6 flex justify-between items-center z-50 mix-blend-difference text-white">
          <div className="font-sans text-xs tracking-[0.2em] uppercase font-bold">Vanguard</div>
        ...
        <footer className="w-full py-24 border-t border-gray-300 mt-20 flex flex-col items-center justify-center px-4 text-center">
          ...
          <input 
            ...
            className="bg-transparent border-b border-magDark px-4 py-2 w-full max-w-xs focus:outline-none focus:border-magAccent transition-colors font-sans"
          />
        </footer>
      </main>
    </SmoothScroll>
